    ...
    <div data-simplebar class="h-100">
        ...
        <div id="sidebar-menu">
            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <!--
                                <li>
                                    <a href="javascript: void(0);" class="has-arrow waves-effect"><i class="mdi mdi-store"></i><span>Tiendas Fisicas</span></a>
                                    <ul class="sub-menu" aria-expanded="false">
                                ...
                                <li>
                                    <a href="javascript: void(0);" class="has-arrow waves-effect"><i class="mdi mdi-poll"></i><span>Ventas</span></a>
                                    <ul class="sub-menu" aria-expanded="false">
                                ...
                                <li>
                                    <a href="javascript: void(0);" class="waves-effect"><i class="mdi mdi-format-list-bulleted-type"></i><span class="badge badge-pill badge-danger float-right">6</span><span>Pedidos</span></a>
                                    <ul class="sub-menu" aria-expanded="false">
                                ...
                                <li>
                                    <a href="javascript: void(0);" class="has-arrow waves-effect"><i class="mdi mdi-book"></i><span>Catalogos</span></a>
                                    <ul class="sub-menu" aria-expanded="false">
                ...
                <li>
                    <a href="javascript: void(0);" class="has-arrow waves-effect"><i class="mdi mdi-cart"></i><span>Carrito de Compras</span></a>
                    <ul class="sub-menu" aria-expanded="false">
                ...
                <li><a href="sobre_nosotros.php" class=" waves-effect"><i class="mdi mdi-hand-right"></i><span>Sobre Nosotros</span></a>
                </li>
                ...
                <li>
                    <a href="javascript: void(0);" class="has-arrow waves-effect"><i
                                class="mdi mdi-contact-phone"></i><span> Atencion al Cliente</span></a>
                    <ul class="sub-menu" aria-expanded="true">

                        <li><a href="preguntas_frecuentes.php">Preguntas Frecuentes</a></li>
                        <li><a href="contactanos.php">Has tu pregunta</a></li>
